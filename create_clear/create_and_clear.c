...
void	clear_window(t_fdf_gen *data)
{
	...
	data->img_data->img_ptr = mlx_new_image(
		data->data->mlx_ptr,
		data->data->win_width,
		data->data->win_height
		);
	data->img_data->img_data = mlx_get_data_addr(
		data->img_data->img_ptr,
		&data->img_data->bpp,
		&data->img_data->size_line,
...
int	init_mlx(t_fdf_gen *data)
{
	...
	mlx_get_screen_size(data->data->mlx_ptr, &data->data->win_width, &data->data->win_height);
	data->data->win_ptr = mlx_new_window(data->data->mlx_ptr, data->data->win_width, data->data->win_height, "FDF");
